...
router.route("/").get(validateToken, getBankDocuments).post(validateToken, createBankDocuments);

router.route("/total").get(validateToken, getBankDocumentsCount);

router.route("/:bankDocumentsId/changestatus/:statusId").put(validateToken, changeBankDocumentsStatus);
